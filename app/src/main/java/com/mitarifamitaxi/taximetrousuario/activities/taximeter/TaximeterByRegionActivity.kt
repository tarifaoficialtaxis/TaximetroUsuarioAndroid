...
import com.mitarifamitaxi.taximetrousuario.viewmodels.taximeter.TaximeterByRegionViewModel
import com.mitarifamitaxi.taximetrousuario.viewmodels.taximeter.TaximeterByRegionViewModelFactory
...
class TaximeterByRegionActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sharedPref = this.getSharedPreferences("CityAreaData", MODE_PRIVATE)
